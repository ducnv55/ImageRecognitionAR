...
//        Alamofire.request("http://172.20.10.8:3000/api/scname=\(self.scname!)").responseJSON { response in
        Alamofire.request("http://192.168.0.99:3000/api/scname=\(self.scname!)").responseJSON { response in
